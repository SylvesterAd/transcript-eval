...
Focus on the "description" field — this is your primary source for keywords. Also consider "type_group" and "source_feel" for context.
...
The 3 sets must follow Rules 1-5:
- Set 1: Literal description using simple everyday words (Rule 5 Simple)
- Set 2: Literal description using technical/domain-specific terms (Rule 5 Technical)
...
[
  {
    ...
    "keywords": [
      ...
      { "query_2w": "document evidence", "query_3w": "press article highlighted" },
      { "query_2w": "media scandal", "query_3w": "shocking revelation proof" }
    ]
  }
]
\`\`\``
