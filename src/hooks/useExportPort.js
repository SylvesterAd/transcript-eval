      ...
      switch (msg.type) {
        ...
        case 'complete':
          dispatch({ type: 'message_complete', payload: {
            ...
            folder_path_absolute: msg.folder_path_absolute,
  ...
  function attachReconnectedHandlers(h) {
    h.onMessage((msg) => {
      ...
      switch (msg.type) {
        ...
        case 'complete':  dispatch({ type: 'message_complete', payload: { ok_count: msg.ok_count, fail_count: msg.fail_count, folder_path: msg.folder_path, folder_path_absolute: msg.folder_path_absolute, xml_paths: msg.xml_paths }}); break
