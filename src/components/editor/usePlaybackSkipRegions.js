 ...
 * merging). On every `timeupdate` event of the video element, if the
 * playhead is inside a skip region, jumps to the region's end + a tiny
 * epsilon to avoid re-triggering on the same frame.
 *
